...
echo.	===== 靠谱鱼-激活神器 =====
echo.
echo. 访问网站下载最新版激活神器:http://kms.kaopuyu.com
echo.
echo. 请输入对应数字进行操作:
echo.
...
echo.
echo.
echo. 正在检查激活服务器：http://kms.kaopuyu.com 请稍后.....
...
if DEFINED _Office16Path (cls & echo. & echo. & echo. & echo. 已发现 Office2016
  ...
  ) else (cls & echo. & echo. & echo. & echo. 未发现系统安装 Office套件！你可能修改了默认安装路径！ & echo. & echo. 请访问：http://kms.kaopuyu.com 按教程手动激活！ &echo.)
echo.
echo. 操作已完成！按任意键返回开始菜单。
pause>nul
goto begin
...
echo.
echo.
echo. ***** 无法连接到服务器，请访问 http://kms.kaopuyu.com 获取最新版 *****
echo.
echo.
echo. 操作已完成！按任意键返回开始菜单。
pause>nul
...
if DEFINED _Office16Path (cls & echo. & echo. & echo. & echo. 已发现 Office2016
  ...
  ) else (cls & echo. & echo. & echo. & echo. 未发现系统安装 Office套件！你可能修改了默认安装路径！ & echo. & echo. 请访问：http://kms.kaopuyu.com 按教程手动卸载激活！ & echo.)
echo.
echo. 操作已完成！按任意键返回开始菜单。
pause>nul
goto begin
